...
final artefacts = <ArtefactDescriptions>[
  ArtefactDescriptions(
    type: ArtifactType.laptop,
    title: 'Trashputer',
  ...
  ArtefactDescriptions(
    type: ArtifactType.car,
    title: 'WW (Waste Wanderer)',
    header: 'Car constructed from recycled materials',
    details: 'The futuristic urban SUV, ingeniously crafted entirely from recycled materials.',
    description:
